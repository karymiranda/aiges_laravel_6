...
@section('tittle', 'Recurso Humano/Ver expediente')
@section('content')
...
<div class="nav-tabs-custom">
  <ul class="nav nav-tabs pull-right">
    ...
    <li class="pull-left header">EXPEDIENTE PERSONAL<li>
  </ul>
  <div class="tab-content">

    <div class="tab-pane" id="tab_4-4">
     <div class="box-body">
      <?php if($empleado->empleado_estudio->first()!=null){ ?>
      <table class="table table-bordered table-striped" id="tablaBusquedaauxiliar">
        ...
        <tbody>
          @foreach($empleado->empleado_estudio as $estudio)
          <tr> 
...
<!--/////////////////////////////////////////////////////////////////////////////////////////-->
      ...
      <div class="box-body">
        ...
        <!--li class="user-header"-->
          <output id="list"><img src="{{asset('/imagenes/Recursohumano/'.$usuario->foto)}}" height="200px" class="" alt="User Image"></output>
        <!--/li-->
          <hr>
        </div>
        ...
        <div class="form-group">                                           
          ...
          <div class="col-sm-5">          
            ...
            <input type="radio" name="v_genero" disabled="false" class="flat-red" value="Femenino" <?php if($genero=="Femenino"){ ?> checked="checked" <?php } ?> >
            {!! Form::label('lbmas', 'Masculino',['class'=>'control-label']) !!}
            <input type="radio" name="v_genero" disabled="false" class="flat-red" value="Masculino" <?php if($genero=="Masculino"){ ?> checked="checked" <?php } ?> >
          </div> 
        </div>
        <div class="form-group">                                           
