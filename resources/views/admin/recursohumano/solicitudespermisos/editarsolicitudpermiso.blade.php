...
<div class="box box-primary box-solid">
  <div class="box-header with-border">
    <h1 class="box-title">ACTUALIZAR SOLICITUD</h1>
  </div>
  <!-- /.box-header -->
  <!-- form start --> 
  @if(count($errors) > 0)
  ...
  <div class="box-body">
    {!! Form::open(['route'=>['actualizarsolicitudespermisorh',$permiso->id], 'method'=>'PUT','class'=>'form-horizontal']) !!}
    ...
    <div class="form-group">                                           
      ...
      <div class="col-sm-5">
        ...
        <div class="col-sm-5">
          {!! Form::text('nip',$permiso->empleado->v_nip,['class'=>'form-control pull-right','placeholder'=>'Número de Identificaión Personal', 'readonly','id'=>'nip','required']) !!}
        </div>
      </div>
    ...
    <div class="form-group"> 
      ...
      <div class="col-sm-5">
        <div class="input-group">
          ...
          <input type="text" name="periodo" value="{{ $permiso->f_desde . ' - ' . $permiso->f_hasta }}" class="form-control pull-right rangoPeriodo" readonly="true">
        </div>
      </div>
      </div>
...
<div class="form-group">
  <div class="col-sm-4">
   ...
   <div class="col-sm-5">
     <label><input type="checkbox" id="super" name="duracionhoras"<?php if($permiso->i_tiemposolicitado==0){ ?> checked="checked" value="1" <?php } ?>>La duración del permiso es menor a 1 dia</label>
</div>
</div>
...
<div class="form-group">
  ...
  {!! Form::checkbox('sinfinesdesemana', 'checksinfinesdesemana', false,['id'=>'sinfindesemana'])!!}
      ...
      <div class="form-group"> 
        ...
        <div class="col-sm-5">
          {!! Form::number('i_tiemposolicitado',$permiso->i_tiemposolicitado,['class'=>'form-control pull-right','placeholder'=>'Tiempo solicitado','id'=>'dias','required','readonly']) !!}
        </div>
      </div>
...
<div class="form-group">
                    {!! Form::label("lbhoraE","Horas",["class"=>"col-sm-4 control-label"]) !!}
                            <div class="col-sm-2">
                              <div class="input-group">
                                <input type="number" name="i_horas" id="horas" class="form-control pull-right time start" placeholder="Horas" readonly="true" value="{{$permiso->i_horas}}">
                                <div class="input-group-addon">
                                  <i class="fa fa-clock-o"></i>
                                </div>
                              </div>
