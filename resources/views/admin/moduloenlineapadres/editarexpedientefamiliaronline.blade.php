...
@section('tittle','Padres de Familia/Actualizar Expediente')
@section('content')

<div class="box box-primary box-solid">
            <div class="box-header with-border">
              <h3 class="box-title"><Strong>ACTUALIZAR EXPEDIENTE</Strong></h3>
            </div>

 {!! Form::open(['route'=>['modificarexpedientefamiliaronline',$familiar->id], 'method'=>'PUT','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
...
<div class="box-body">
   ...
   <div class="col-sm-12" align="center">
          ...
          @foreach($user as $user)                                
              <img src="{{asset('/imagenes/Administracionacademica/Padresdefamilia/'.$user->foto)}}" height="200px" class="" alt="User Image"> 
    ...
    <input type="file" id="files" name="txtfoto" accept="image/*" />                  
          ...
          <div class="form-group">                                           
           ...
           <div class="col-sm-5">
             {!! Form::text('nombres',$familiar->nombres,['class'=>'form-control pull-right','placeholder'=>'Nombres ','required']) !!}
                 ...
                 <div class="form-group">             {!! Form::label('apellidos', 'Apellidos *',['class'=>'col-sm-4 control-label']) !!}
                                                <div class="col-sm-5">
          ...
          <!--div class="form-group">                                                       
          {!! Form::label('', 'Encargado *',['class'=>'col-sm-4 control-label']) !!}
          <div class="col-sm-5">
             {!! Form::label('', 'SI',['class'=>'col- control-label']) !!}
             <input type="radio" name="encargado" class="flat-red" value="SI" <?php if($familiar->encargado=="SI"){ ?> checked="checked" <?php }?> >         
          {!! Form::label('', 'NO',['class'=>'col- control-label']) !!}
              <input type="radio" name="encargado" disabled="true" class="flat-red" value="NO" <?php if($familiar->encargado=="NO"){ ?> checked="checked" <?php } ?> >
          </div> 
 </div-->

                 <!--div class="form-group">
         {!! Form::label('lbretirarestudiante', 'Autorizado a retirar a estudiante *',['class'=>'col-sm-4 control-label']) !!}                  
          <div class="col-sm-5">
            {!! Form::label('', 'SI',['class'=>'col- control-label']) !!}
             <input type="radio" name="autorizacion" disabled="true" class="flat-red" value="SI" <?php if($familiar->autorizacion=="SI"){ ?> checked="checked" <?php }?> >         
          {!! Form::label('', 'NO',['class'=>'col- control-label']) !!}
              <input type="radio" name="autorizacion" class="flat-red" value="NO" <?php if($familiar->autorizacion=="NO"){ ?> checked="checked" <?php } ?> >
        ...
        <div class="col-sm-5">
          ...
          <div class="form-group">                                           
              ...
              <a href="{{route('expedienteonline',$familiar->id)}}" class="btn btn-default">Cancelar</a>
              </div>
