...
<div class="box box-primary box-solid">
  ...
  @endif
  <div class="box-body">
    {!! Form::open(['route'=>'guardartraslado', 'method'=>'POST','class'=>'form-horizontal']) !!}
    ...
    {!! Form::hidden('activo_id',null,['id'=>'activo_id']) !!}
        ...
        <div class="form-group">
          ...
          <div class="col-sm-5">
            {!! Form::text('txtdescrip',null,['class'=>'form-control pull-right','placeholder'=>'Descripción','readonly','id'=>'descripcion']) !!}
          </div>
        </div>
        ...
        <div class="form-group">                                           
          ...
          <div class="col-sm-5">
            {!! Form::select('v_condicionactivo',['Bueno'=>'Bueno','Malo'=>'Malo'], null,['class'=>'form-control','disabled','id'=>'condicion'])!!}
          </div>
          </div><!--fin form group-->      
        <div class="form-group">
          {!! Form::label('lbserie', 'Serie',['class'=>'col-sm-4 control-label']) !!}
          <div class="col-sm-5">
            {!! Form::text('txtserie',null,['class'=>'form-control pull-right','placeholder'=>'Número de serie','readonly','id'=>'serie']) !!}
          </div>                                                                 
        </div>
        ...
        <div class="form-group">                                                             
          ...
          <div class="col-sm-5">
            {!! Form::text('txtmodelo',null,['class'=>'form-control pull-right','placeholder'=>'Modelo','readonly','id'=>'modelo']) !!}
          </div>
          </div><!--fin form group-->      
        <div class="form-group">
          {!! Form::label('lbmarca', 'Marca',['class'=>'col-sm-4 control-label']) !!}
          <div class="col-sm-5">
            {!! Form::text('txtmarca',null,['class'=>'form-control pull-right','placeholder'=>'Marca','readonly','id'=>'marca']) !!}
          </div>
        </div>
