...
<div class="box box-primary box-solid">
  ...
  <!-- form start -->        
  <div class="box-body">
    {!! Form::open(['route'=>'agregarcatalogoactivo','method'=>'POST','class'=>'form-horizontal']) !!}
    {!! Form::hidden('estado', '1') !!}
      <div class="form-group">                                           
        {!! Form::label('lbnivel', 'Nivel',['class'=>'col-sm-4 control-label']) !!}
        <div class="col-sm-5">
          {!! Form::label('lb3', 'Cuenta princial',['class'=>'col- control-label']) !!}
          {!! Form::radio('v_nivel','3',true)!!}
          {!! Form::label('lb4', 'Sub cuenta',['class'=>'control-label']) !!}
          {!! Form::radio('v_nivel','4',false)!!}
        </div> 
      </div>
      <div class="form-group">
        {!! Form::label('lbsup', 'Cuenta Superior',['class'=>'col-sm-4 control-label']) !!}
        <div class="col-sm-5">
          {!! Form::select('v_sup',['12'=>'12 - Activo Fijo'], null,['class'=>'form-control','id'=>'id_niv'])!!}
        </div>
      </div>
      <div class="form-group">                                           
        {!! Form::label('lbcodigo', 'Código',['class'=>'col-sm-4 control-label']) !!}
        <div class="col-sm-5">
          {!! Form::text('v_codigocuenta',null,['class'=>'form-control pull-right','data-mask'=>'','data-inputmask'=>'"mask":"1299","clearIncomplete":"true"','id'=>'id_cod','required'])!!}
        </div>
      </div>
      <div class="form-group"> 
        {!! Form::label('lbnombre', 'Nombre',['class'=>'col-sm-4 control-label']) !!}          
        <div class="col-sm-5">            
          {!! Form::text('v_nombrecuenta',null,['class'=>'form-control pull-right','placeholder'=>'Nombre de la Cuenta','required']) !!}
        </div> 
      </div>
