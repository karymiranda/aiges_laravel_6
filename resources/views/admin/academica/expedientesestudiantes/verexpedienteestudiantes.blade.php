...
@section('tittle','Administracion Académica/Ver Expediente')
@section('content')
...
<div class="tab-pane " id="tab_3-3">
  ...
  @foreach($datos as $g)
                ...
                <tr>            
                 <td>{{$g[0]->anio}}</td>
                 <td>{{$g[0]->descripcion}}</td>
                 <td>{{$g[0]->v_nombres}}{{$g[0]->v_apellidos}}</td>                  
                    <?php if($g[0]->promovido=='1')
                    {echo"<td><span class='label label-success'>Promovido</span> ";echo"</td>";}
                    else if($g[0]->promovido==0)
                      {echo"<td><span class='label label-danger'>Retenido</span> ";echo"</td>";}
                      else
                        {echo"<td><span class='label label-warning'>Pendiente</span>";echo"</td>";} ?> 
                  
              <td>
              <a href="{{route('vercalificacionesexpediente',[$estudiante->id,$g[0]->anio])}}"  title="Ver calificaciones" class="btn btn-warning"><i class="fa fa-calculator"></i></a>
              </td> 
                </tr>                
...
<h4 align="center">SITUACION FAMILIAR</h4><hr>
  ...
  <div class="form-group">                                           
                   {!! Form::label('cantfam', 'Miembros',['class'=>'col-sm-4 control-label']) !!}
                                                <div class="col-sm-5">
                                                {!! Form::text('i_catFamiliares',$estudiante->i_catFamiliares,['class'=>'form-control pull-right','placeholder'=>'Número de miembros que conforman su núcleo familiar','readonly']) !!}
                                                </div>
                </div>
          </td> 
          </tr>
...
<div class="form-group">  
 ...
 <div class="box-footer" align="right">  
   <a href="{{route('listaexpedientes')}}" class="btn btn-default">Regresar</a>
 </div>
 </div>
@endsection
