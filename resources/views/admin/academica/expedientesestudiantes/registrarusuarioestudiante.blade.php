...
@section('tittle','Administración académica/Crear Cuenta de Usuario')
@section('content')

<div class="box box-primary box-solid">
            <div class="box-header with-border ">
              <h3 class="box-title"><Strong>CREAR CUENTA DE USUARIO:  {{ $estudiante->v_nombres. ' ' .$estudiante->v_apellidos }} </Strong></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
    @if($errors->any())
...
@endif     
    <div class="box-body">
                 {!! Form::open(['route'=>'guardarcuentausuarioestudiante', 'method'=>'POST', 'class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
 <input type="hidden" name="id" value="{{$estudiante->id}}">  



          <div class="col-sm-12" align="center">
            <!--li class="user-header"--><output id="list"><img src="{{ asset('imagenes/Administracionacademica/Estudiantes/nofound.jpg') }}" height="200px" class="image-circle" alt="User Image"></output>
      <!--/li-->
              <hr>
          </div>
    ...
    <input type="file" id="files" name="txtfoto" accept="image/*" />                  
            ...
            <div class="form-group">                                           
                                                ...
                                                <div class="col-sm-4">
                                                {!! Form::text('name',$estudiante->v_expediente,['class'=>'form-control pull-right','placeholder'=>'Cuenta de usuario','readonly']) !!}
                                                </div>
              </div>
              <div class="form-group">                                           
