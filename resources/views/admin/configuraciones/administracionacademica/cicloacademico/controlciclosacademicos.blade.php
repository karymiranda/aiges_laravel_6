...
@section('tittle','Configuraciones/Administración Académica/Ciclos Académicos')
@section('content')
<div class="box box-primary">
            <div class="box-header">
               <div class="col-sm-12" align="center">
              <h2> <label class="text-primary">CICLOS ACADEMICOS</label></h2>
              </div>
    {!! Form::open(['route'=>'registrarcicloacademico', 'method'=>'GET', 'class'=>'form-horizontal','id'=>'formulario']) !!}
    <input type="hidden" id="mostrarboton" value="{{$mostrarboton}}">
              <div class="col-sm-12" align="right">         
                <a href="#" class="btn btn-primary" id="btnnuevo">Registrar ciclo</a>
          </div>
      </div>
  {!! Form::close() !!}
  <HR>
  ...
  <ul>
        ...
        <a href="{{route('editarcicloacademico',$ciclos->id)}}" class="btn btn-success" title="Editar"><i class="fa fa-edit"></i></a>                    
      <!--a  href="#" class="btn btn-danger"  disabled="true"><i class="fa fa-close"></i></a-->
             
              @if($ciclos->estado=='1')
              <a  href="#" class="btn btn-danger" title="Clausurar ciclo escolar" data-toggle="modal" data-target="#ciclos_{{$ciclos->id}}"><i class="fa fa-calendar-times-o"></i></a>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <p>¿Está seguro, desea <b>CLAUSURAR</b> el  {{$ciclos->nombre}}?</p>
                    </div>
                    <div class="modal-footer">
                 <form method="GET" action="{{route('clausurarcicloacademico',$ciclos->id)}}" id="formclausurar">
...
if($('#mostrarboton').val()!=0)
{
   ...
   $('#errores').append("<li>Para agregar un nuevo ciclo escolar debe clausuar el ciclo activo.</li>");
}
else 
{
  $('#formulario').submit();
