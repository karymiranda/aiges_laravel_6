...
@section('tittle','Configuraciones/Administración Académica/Asistencias')
@section('content')
...
<!--div class="alert alert-success alert-dismissible">
    ...
    <div class="box-footer" align="right">
      <a href="{{route('tomarasistencia_view',['id' => $params['seccion_id']])}}" class="btn btn-default">finalizar</a>
    </div>
  </form>
</div>
@endsection